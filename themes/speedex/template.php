...
if (theme_get_setting('speedex_fixed')) {
 ...
 */
function speedex_theme(&$existing, $type, $theme, $path) {
...
function speedex_preprocess(&$vars, $hook) {
...
//    dsm($vars);
   if(in_array('page-node',$vars['template_files']) === TRUE){
    $vars['body_classes'] .=  ' secion-admin';
   }
}
 ...
 */
/* -- Delete this line if you want to use this function
function speedex_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function speedex_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
...
function speedex_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
